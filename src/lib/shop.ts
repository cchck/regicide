...
export const ITEMS: ShopItem[] = [
  ...
  { id: 'table.deco', slot: 'table', name: '装饰艺术赌桌', blurb: '雕花桌沿，皮革包边，内嵌一圈金线。', rarity: 'fine', price: 800, ready: false },
  { id: 'table.obsidian', slot: 'table', name: '黑曜石台', blurb: '一整块磨光的黑石。牌落上去没有声音。', rarity: 'rare', price: 2200, ready: false },
  { id: 'table.jade', slot: 'table', name: '血玉牌桌', blurb: '玉里的红丝像凝住的血。据说它记得每一个死在这的人。', rarity: 'legend', price: 6000, ready: false },

  // ——— 灯具 ———
  { id: 'light.bulb', slot: 'light', name: '裸灯泡', blurb: '一根线吊着，风一过就晃。地下赌局的标准配置。', rarity: 'common', price: 0, ready: true },
  { id: 'light.deco', slot: 'light', name: '黄铜吊灯', blurb: '十二支烛台，装饰艺术的黄金骨架。', rarity: 'fine', price: 900, ready: true },
  { id: 'light.skull', slot: 'light', name: '骨灯', blurb: '烛火从眼窝里透出来。没人问过那是谁的头骨。', rarity: 'rare', price: 2600, ready: false },

  // ——— 座椅 ———
  { id: 'seat.plain', slot: 'seat', name: '折叠铁椅', blurb: '冷、硬、吱呀作响。坐着的人不在乎。', rarity: 'common', price: 0, ready: true },
  { id: 'seat.throne', slot: 'seat', name: '鎏金王座', blurb: '猩红丝绒配鎏金雕花。他坐上去像在审判你。', rarity: 'fine', price: 1000, ready: true },
  { id: 'seat.bone', slot: 'seat', name: '骨王座', blurb: '用输家的东西堆起来的。别问是什么骨头。', rarity: 'legend', price: 5000, ready: false },

  // ——— 桌面陈设 ———
  { id: 'props.tin', slot: 'props', name: '铁皮烟灰缸', blurb: '瘪了一角，积着灰。桌上就这么一件东西。', rarity: 'common', price: 0, ready: true },
  { id: 'props.vice', slot: 'props', name: '绅士的恶习', blurb: '燃着的雪茄、水晶醒酒器、一捆扎好的钞票——一整套派头。', rarity: 'fine', price: 700, ready: true },

  // ——— 房间 ———
  { id: 'room.concrete', slot: 'room', name: '水泥地下室', blurb: '裸墙，霉斑，一扇焊死的窗。没人会来找你。', rarity: 'common', price: 0, ready: true },
  { id: 'room.deco', slot: 'room', name: '午夜沙龙', blurb: '深蓝墙面、猩红壁柱、垂到地板的天鹅绒幕布，还有一圈立柱。', rarity: 'rare', price: 1800, ready: true },

  // ——— 庄家 ———
  { id: 'dealer.hood', slot: 'dealer', name: '兜帽庄家', blurb: '看不见脸，只看得见那两点红光。', rarity: 'common', price: 0, ready: true },
  { id: 'dealer.priest', slot: 'dealer', name: '赌场祭司', blurb: '他管这叫仪式，不叫赌局。', rarity: 'rare', price: 2400, ready: false },
  { id: 'dealer.general', slot: 'dealer', name: '败军之将', blurb: '勋章还挂着，军队早没了。', rarity: 'rare', price: 2400, ready: false },
  { id: 'dealer.child', slot: 'dealer', name: '穿西装的孩子', blurb: '最让人不安的那种对手。', rarity: 'legend', price: 4800, ready: false },

  // ——— 牌背 ———
  { id: 'cardBack.house', slot: 'cardBack', name: '庄家纹章', blurb: '标准牌背。所有人都是从这副牌开始的。', rarity: 'common', price: 0, ready: true },
  { id: 'cardBack.gilt', slot: 'cardBack', name: '烫金几何', blurb: '装饰艺术的放射纹，边缘压金。', rarity: 'fine', price: 400, ready: false },
  { id: 'cardBack.blood', slot: 'cardBack', name: '血手印', blurb: '一枚按在牌背上的掌印。你希望那是印上去的。', rarity: 'rare', price: 1500, ready: false },

  // ——— 耳钻 ———
  { id: 'drill.iron', slot: 'drill', name: '锈铁钻', blurb: '出厂那台。锈是真的，声音也是真的。', rarity: 'common', price: 0, ready: true },
  { id: 'drill.brass', slot: 'drill', name: '黄铜钻', blurb: '擦得锃亮。让处刑显得体面一点。', rarity: 'fine', price: 900, ready: false },
];
